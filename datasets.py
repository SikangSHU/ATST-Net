...
class ImageDataset(Dataset):
    def __init__(self, root, transforms_=None, batch_size=None, unaligned=False):
        ...
        self.files_B = sorted(glob.glob(os.path.join(root, 'IHC') + '/*/*.png'))
    ...
    def __getitem__(self, index):
        ...
        return {'HE': item_A, 'IHC': item_B, 'filename_HE': os.path.basename(file_A)}
...
class AutoannoDataset_mask(Dataset):
    def __init__(self, export_root, batch_size=None, unaligned=False):
        self.batch_size = batch_size
        self.transform_img = transforms.Compose([
            transforms.RandomHorizontalFlip(),
    ...
    def __getitem__(self, index):
        ...
        return {'HE_autoanno': expert_item_A, 'HE_autoanno_mask': expert_item_A_mask}

    def __len__(self):
        return len(self.files_expert_A)//self.batch_size * self.batch_size